(function(root) {
  ...
  var config = {
    apiKey: "AIzaSyAOWgdE7Ig7YNo-OLXMk5TLBEN_aGE4OfA",
    authDomain: "wcc-2018.firebaseapp.com",
    databaseURL: "https://wcc-2018.firebaseio.com",
    projectId: "wcc-2018",
    storageBucket: "wcc-2018.appspot.com",
    messagingSenderId: "831877037125"
  };
  ...
  function copyMarkerDataValues(formMarkerData) {
    ...
    for (var key in structureObject) {
      if (structureObject.hasOwnProperty(key)) {
        copy[key] = formMarkerData.hasOwnProperty(key)
          ? formMarkerData[key]
          : undefined;
      }
    }
